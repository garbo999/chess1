...
_p4d_proto.next_move = function(){
    ...
    console.log('file: display_test_1.js function: _p4d_proto.next_move');
...
_p4d_proto.computer_move = function(){
    ...
    console.log('file: display_test_1.js function: _p4d_proto.computer_move');
...
function P4wn_display(target){
    ...
    console.log('file: display_test_1.js function: P4wn_display');
...
function p4wnify(id){
    ...
    console.log('file: display_test_1.js function: p4wnify');
